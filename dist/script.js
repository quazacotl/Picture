...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    function appendErrMessage(triggerSelector) {
      var bttn = document.querySelector(triggerSelector),
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (triggerSelector === '.popup_calc_button' && (!windowWidth.value || !windowHeight.value)) {
          ...
          giftPicture.style.marginRight = "".concat(scroll, "px"); // document.body.classList.add('modal-open');
        }
      });
    });
    close.addEventListener('click', function () {
      ...
      giftPicture.style.marginRight = "0px"; // document.body.classList.remove('modal-open');
    });
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      ...
      if (!display) {
        ...
        document.body.style.overflow = 'hidden';
        scroll = calcScroll();
        var giftPicture = document.querySelector('.fixed-gift');
        document.body.style.marginRight = "".concat(scroll, "px");
        giftPicture.style.marginRight = "".concat(scroll, "px");
      }
    }, time);
  }
...
var slides = function slides(_slides, dir, prev, next) {
  var slideIndex = 1,
      paused = false;
